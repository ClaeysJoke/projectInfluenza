PROGRAM drawinvbay
  ...
  real (kind = selected_real_kind(8) ) :: kappa, lambda, S0, I0,R0,beta
...
!OK
function rand_normal ( a, b) result(c)
  implicit none

  real ( kind = selected_real_kind(8) ) :: a,b,r1,r2,c,two
  real ( kind = selected_real_kind(8) ), parameter :: r8_pi = 4*ATAN(real(1.0,kind=selected_real_kind(8)))
  
  call init_random_seed()
  call random_number(r1)
  call random_number(r2)
  two=2.0
  c = sqrt ( - two * log ( r1 ) ) * cos ( two * r8_pi * r2 )
