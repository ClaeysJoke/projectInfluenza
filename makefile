...
# Link step
MetropolisTest:MVSTAT.o DIFF_SOLVER.o PsiModule.o Pdf.o GetModule.o ODE.o GradientModule.o Normal.o Reading.o Sampling.o Prior.o Metropolis.o
	$(F90) -o MetropolisTest MVSTAT.o DIFF_SOLVER.o PsiModule.o Pdf.o GetModule.o ODE.o GradientModule.o Normal.o Reading.o Sampling.o Prior.o Metropolis.o
